pipeline{
    ...
    environment{
        ...
        DEV_SERVER_IP ='ec2-user@13.233.97.7'
        TEST_SERVER_IP ='ec2-user@65.0.100.229'
    }
    stages{
    ...
    sh "ssh ${TEST_SERVER_IP} sudo bash /home/ec2-user/docker-files/docker-compose-script.sh ${IMAGE_NAME}"
            }
        }
    }
    }
